...
namespace UnitTests.ResourceHooks
{
    public sealed class DiscoveryTests
    {
        ...
        public sealed class DummyResourceDefinition : ResourceHooksDefinition<Dummy>
        {
            ...
            public override IEnumerable<Dummy> BeforeDelete(IResourceHashSet<Dummy> affected, ResourcePipeline pipeline)
            {
                return affected;
            }
        ...
        public sealed class YetAnotherDummyResourceDefinition : ResourceHooksDefinition<YetAnotherDummy>
        {
            ...
            public override IEnumerable<YetAnotherDummy> BeforeDelete(IResourceHashSet<YetAnotherDummy> affected, ResourcePipeline pipeline)
            {
                return affected;
            }
