...
namespace UnitTests.ResourceHooks
{
    public class HooksTestsSetup : HooksDummyData
    {
            ...
            where TResource : class, IIdentifiable<int>
        {
            ...
            mock.Setup(discovery => discovery.DatabaseValuesEnabledHooks).Returns(new[]
            {
                ResourceHook.BeforeImplicitUpdateRelationship
            }.Concat(enableDbValuesHooks).ToArray());
        ...
        {
            var dbContextResolvers = new[]
            {
                new DbContextResolver<AppDbContext>(context)
            };
