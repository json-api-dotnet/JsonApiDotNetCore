...
namespace UnitTests.ResourceHooks
{
    public class BeforeUpdate_WithDbValues_Tests : HooksTestsSetup
    {
        ...
        public void BeforeUpdate()
        {
            ...
            // assert
            todoResourceMock.Verify(rd => rd.BeforeUpdate(It.Is<IAffectedResourcesDiffs<TodoItem>>((diff) => TodoCheck(diff, description)), ResourcePipeline.Patch), Times.Once());
        ...
        private bool TodoCheck(IAffectedResourcesDiffs<TodoItem> diff, string checksum)
        {
