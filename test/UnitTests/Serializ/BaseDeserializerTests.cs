...
{
    public class BaseDeserializerTests : DeserializerTestsSetup
    {
        private readonly DeserializerBase _deserializer;
        public BaseDeserializerTests()
        {
        ...
        {
            var content = new Documents { Data = new List<ResourceObject> { } };
            var body = JsonConvert.SerializeObject(content);
           ...
           // arrange
            var content = new Document
            {
                Data = new ResourceObject
                {
                    ...
                    Attributes = new Dictionary<string, object>
                    {
                        { "complex-field", new Dictionary<string, object> { {"compound-name", "testName" } } }
                    }
                }
            };
            var body = JsonConvert.SerializeObject(content);
        ...
        public void DeserializeAttributes_ComplexListType_CanDeserialize()
        {
            ...
            var content = new Document
            {
                Data = new ResourceObject
                {
                    ...
                    Attributes = new Dictionary<string, object>
                    {
                        { "complex-fields", new [] { new Dictionary<string, object> { {"compound-name", "testName" } } } }
                    }
                }
            };
            var body = JsonConvert.SerializeObject(content);
