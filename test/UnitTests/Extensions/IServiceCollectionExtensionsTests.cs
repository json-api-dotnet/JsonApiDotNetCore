...
namespace UnitTests.Extensions
{
    public sealed class IServiceCollectionExtensionsTests
    {
        ...
        private class IntResourceService : IResourceService<IntResource>
        {
            ...
            public Task AddRelationshipAsync(int id, string relationshipName, IEnumerable<IIdentifiable> relatinshipValues) => throw new NotImplementedException();
        ...
        private class GuidResourceService : IResourceService<GuidResource, Guid>
        {
            ...
            public Task AddRelationshipAsync(Guid id, string relationshipName, IEnumerable<IIdentifiable> relatinshipValues) => throw new NotImplementedException();
