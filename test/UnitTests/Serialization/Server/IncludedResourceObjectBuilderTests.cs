...
namespace UnitTests.Serialization.Server
{
    public sealed class IncludedResourceObjectBuilderTests : SerializerTestsSetup
    {
        ...
        {
            // Arrange
            (Article article, Person author, Food _, Person reviewer, Food _) = GetAuthorChainInstances();
        ...
        {
            // Arrange
            (Article article, Person author, Food _, Person _, Food _) = GetAuthorChainInstances();
        ...
        public void BuildIncluded_OverlappingDeeplyNestedCircularChains_CanBuild()
        {
            // Arrange
            List<RelationshipAttribute> authorChain = GetIncludedRelationshipsChain("author.blogs.reviewer.favoriteFood");
            (Article article, Person author, Food _, Person reviewer, Food reviewerFood) = GetAuthorChainInstances();
