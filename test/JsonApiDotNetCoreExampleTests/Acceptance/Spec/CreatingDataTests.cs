...
//            var deserializedBody = (TodoItem)_fixture.GetDeserializer().Deserialize(body);
...
//            var response = await client.SendAsync(request);
//            var body = await response.Content.ReadAsStringAsync();
//            var deserializedBody = (TodoItemCollection)_fixture.GetDeserializer().Deserialize(body);
...
//            Assert.Equal(HttpStatusCode.Created, response.StatusCode);
//            var body = await response.Content.ReadAsStringAsync();
//            var collectionResult = _fixture.GetDeserializer().Deserialize<TodoItemCollection>(body);
...
//            // assert
//            Assert.Equal(HttpStatusCode.Created, response.StatusCode);
//            var todoItemResult = (TodoItem)_fixture.GetDeserializer().Deserialize<TodoItem>(body);
...
//            // assert
//            Assert.Equal(HttpStatusCode.Created, response.StatusCode);
//            var deserializedBody = (PersonRole)_fixture.GetDeserializer().Deserialize(body);
