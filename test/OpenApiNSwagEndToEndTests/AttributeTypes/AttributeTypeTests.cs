...
using OpenApiNSwagEndToEndTests.AttributeTypes.GeneratedCode;
using OpenApiTests;
using OpenApiTests.AttributeTypes;
using TestBuildingBlocks;
using Xunit;
using Xunit.Abstractions;
using ClientDayOfWeek = OpenApiNSwagEndToEndTests.AttributeTypes.GeneratedCode.DayOfWeek;
using ServerDayOfWeek = System.DayOfWeek;

namespace OpenApiNSwagEndToEndTests.AttributeTypes;
...
public sealed class AttributeTypeTests : IClassFixture<IntegrationTestContext<AttributeTypesStartup, AttributeTypesDbContext>>, IDisposable
{
    ...
    public async Task Can_create_resource_with_all_attributes_set_to_valid_values()
    {
        ...
        AttributeTypesClient apiClient = new(httpClient);
        ...
        var requestBody = new CreateTypeContainerRequestDocument
        {
            Data = new DataInCreateTypeContainerRequest
            {
                Attributes = new AttributesInCreateTypeContainerRequest
                {
                    ...
                    TestDateOnly = newContainer.TestDateOnly.ToDateTime(default, DateTimeKind.Local),
                    TestNullableDateOnly = newContainer.TestNullableDateOnly?.ToDateTime(default, DateTimeKind.Local),
                    TestTimeOnly = newContainer.TestTimeOnly.ToTimeSpan(),
                    TestNullableTimeOnly = newContainer.TestNullableTimeOnly?.ToTimeSpan(),
        ...
        // Act
        PrimaryTypeContainerResponseDocument response = await apiClient.PostTypeContainerAsync(requestBody);
        ...
        response.Data.Attributes.TestDateOnly.Should().Be(newContainer.TestDateOnly.ToDateTime(default, DateTimeKind.Local));
        response.Data.Attributes.TestNullableDateOnly.Should().Be(newContainer.TestNullableDateOnly?.ToDateTime(default, DateTimeKind.Local));
        response.Data.Attributes.TestTimeOnly.Should().Be(newContainer.TestTimeOnly.ToTimeSpan());
        response.Data.Attributes.TestNullableTimeOnly.Should().Be(newContainer.TestNullableTimeOnly?.ToTimeSpan());
        ...
        response.Data.Attributes.TestUri.Should().Be(newContainer.TestUri);
        response.Data.Attributes.TestNullableUri.Should().Be(newContainer.TestNullableUri);
    ...
    public async Task Can_update_resource_with_nullable_attributes_set_to_null()
    {
        ...
        var requestBody = new UpdateTypeContainerRequestDocument
        {
            Data = new DataInUpdateTypeContainerRequest
            {
                ...
                Attributes = new TrackChangesFor<AttributesInUpdateTypeContainerRequest>(apiClient)
                {
                    Initializer =
                    {
        ...
        // Act
        PrimaryTypeContainerResponseDocument response = await apiClient.PatchTypeContainerAsync(existingContainer.StringId!, requestBody);
    ...
    public async Task Cannot_update_resource_with_attribute_set_to_null(string propertyName, bool failAtModelValidation)
    {
        ...
        SetAttributeValueInUpdateRequestToNull(requestBody.Data.Attributes, propertyName, apiClient);

        // Act
        Func<Task> action = async () => await apiClient.PatchTypeContainerAsync(existingContainer.StringId!, requestBody);
    ...
    public async Task Cannot_update_resource_with_attribute_set_to_invalid_value(string propertyName, string innerParseError)
    {
        ...
        SetAttributeValueInUpdateRequestToInvalid(requestBody.Data.Attributes, propertyName, apiClient);
        ...
        error.Source.Should().NotBeNull();
        error.Source.Pointer.Should().Be($"/data/attributes/{propertyName.Camelize()}");
        error.Meta.Should().ContainKey("stackTrace").WhoseValue.Should().BeOfType<JArray>().Which.ToString().Should().Contain(innerParseError);
    }
    ...
    public async Task Can_filter_with_valid_value(string propertyName)
    {
        ...
        // Act
        TypeContainerCollectionResponseDocument response = await apiClient.GetTypeContainerCollectionAsync(queryString);
    ...
    public async Task Cannot_filter_with_null_value(string propertyName)
    {
        ...
        // Act
        Func<Task> action = async () => await apiClient.GetTypeContainerCollectionAsync(queryString);
    ...
    private static void SetAttributeValueInUpdateRequestToNull(AttributesInUpdateTypeContainerRequest attributes, string propertyName, JsonApiClient apiClient)
    {
        ...
        apiClient.MarkAsTracked(attributes, propertyName);
    }
