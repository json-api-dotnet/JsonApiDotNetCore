    ...
    : IClassFixture<IntegrationTestContext<OpenApiStartup<ResourceInheritanceDbContext>, ResourceInheritanceDbContext>>, IDisposable
{
    ...
    public async Task Can_get_primary_resources_at_abstract_endpoint()
    {
        ...
        // Act
        BuildingCollectionResponseDocument response = await apiClient.GetBuildingCollectionAsync();
    ...
    public async Task Can_get_primary_resources_at_concrete_base_endpoint()
    {
        ...
        // Act
        RoadCollectionResponseDocument response = await apiClient.GetRoadCollectionAsync();
    ...
    public async Task Can_get_primary_resources_at_concrete_derived_endpoint()
    {
        ...
        // Act
        FamilyHomeCollectionResponseDocument response = await apiClient.GetFamilyHomeCollectionAsync();
    ...
    public async Task Can_get_primary_resource_at_abstract_endpoint()
    {
        ...
        // Act
        PrimaryBuildingResponseDocument response = await apiClient.GetBuildingAsync(mansion.StringId!);
    ...
    public async Task Can_get_primary_resource_at_concrete_base_endpoint()
    {
        ...
        // Act
        PrimaryRoadResponseDocument response = await apiClient.GetRoadAsync(cyclePath.StringId!);
    ...
    public async Task Can_get_primary_resource_at_concrete_derived_endpoint()
    {
        ...
        // Act
        PrimaryFamilyHomeResponseDocument response = await apiClient.GetFamilyHomeAsync(familyHome.StringId!);
    ...
    public async Task Can_get_secondary_resource_at_abstract_base_endpoint()
    {
        ...
        // Act
        SecondaryResidenceResponseDocument response = await apiClient.GetRoomResidenceAsync(bedroom.StringId!);
    ...
    public async Task Can_get_secondary_resource_at_concrete_derived_endpoint()
    {
        ...
        // Act
        SecondaryResidenceResponseDocument response = await apiClient.GetBedroomResidenceAsync(bedroom.StringId!);
    ...
    public async Task Can_get_secondary_resources_at_concrete_base_endpoint()
    {
        ...
        // Act
        RoomCollectionResponseDocument response = await apiClient.GetResidenceRoomsAsync(familyHome.StringId!);
    ...
    public async Task Can_get_secondary_resources_at_concrete_derived_endpoint()
    {
        ...
        // Act
        RoomCollectionResponseDocument response = await apiClient.GetMansionRoomsAsync(mansion.StringId!);
    ...
    public async Task Can_create_concrete_derived_resource_at_abstract_endpoint_with_relationships_and_includes()
    {
        ...
        // Act
        PrimaryBuildingResponseDocument? response = await ApiResponse.TranslateAsync(async () => await apiClient.PostBuildingAsync(requestBody, queryString));
    ...
    public async Task Can_create_concrete_derived_resource_at_concrete_base_endpoint()
    {
        ...
        // Act
        PrimaryResidenceResponseDocument? response = await ApiResponse.TranslateAsync(async () => await apiClient.PostResidenceAsync(requestBody));
    ...
    public async Task Can_update_concrete_derived_resource_at_abstract_endpoint_with_relationships_and_includes()
    {
        ...
        PrimaryBuildingResponseDocument? response =
            await ApiResponse.TranslateAsync(async () => await apiClient.PatchBuildingAsync(existingFamilyHome.StringId!, requestBody, queryString));
