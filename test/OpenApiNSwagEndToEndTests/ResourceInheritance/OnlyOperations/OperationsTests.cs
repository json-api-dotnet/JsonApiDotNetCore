...
using OpenApiNSwagEndToEndTests.OnlyOperationsInheritance.GeneratedCode;
using OpenApiTests;
...
namespace OpenApiNSwagEndToEndTests.ResourceInheritance.OnlyOperations;
    ...
    : IClassFixture<IntegrationTestContext<OpenApiStartup<ResourceInheritanceDbContext>, ResourceInheritanceDbContext>>, IDisposable
{
    ...
    public async Task Test2()
    {
        ...
        var apiClient = new OnlyOperationsInheritanceClient(httpClient);
