            ...
            schemasElement.Should().ContainPath("atomicOperation").Should().BeJson("""
                {
                  ...
                  "discriminator": {
                    ...
                    "mapping": {
                      "addToCourseEnrollmentsRelationshipOperation": "#/components/schemas/addToCourseEnrollmentsRelationshipOperation",
                      "addToCourseTaughtByRelationshipOperation": "#/components/schemas/addToCourseTaughtByRelationshipOperation",
                      "addToStudentEnrollmentsRelationshipOperation": "#/components/schemas/addToStudentEnrollmentsRelationshipOperation",
                      "addToTeacherMentorsRelationshipOperation": "#/components/schemas/addToTeacherMentorsRelationshipOperation",
                      "addToTeacherTeachesRelationshipOperation": "#/components/schemas/addToTeacherTeachesRelationshipOperation",
                      "createCourseOperation": "#/components/schemas/createCourseOperation",
                      "createEnrollmentOperation": "#/components/schemas/createEnrollmentOperation",
                      "createStudentOperation": "#/components/schemas/createStudentOperation",
                      "createTeacherOperation": "#/components/schemas/createTeacherOperation",
                      "deleteCourseOperation": "#/components/schemas/deleteCourseOperation",
                      "deleteEnrollmentOperation": "#/components/schemas/deleteEnrollmentOperation",
                      "deleteTeacherOperation": "#/components/schemas/deleteTeacherOperation",
                      "removeFromStudentEnrollmentsRelationshipOperation": "#/components/schemas/removeFromStudentEnrollmentsRelationshipOperation",
                      "removeFromTeacherMentorsRelationshipOperation": "#/components/schemas/removeFromTeacherMentorsRelationshipOperation",
                      "removeFromTeacherTeachesRelationshipOperation": "#/components/schemas/removeFromTeacherTeachesRelationshipOperation",
                      "updateCourseEnrollmentsRelationshipOperation": "#/components/schemas/updateCourseEnrollmentsRelationshipOperation",
                      "updateCourseOperation": "#/components/schemas/updateCourseOperation",
                      "updateEnrollmentCourseRelationshipOperation": "#/components/schemas/updateEnrollmentCourseRelationshipOperation",
                      "updateEnrollmentOperation": "#/components/schemas/updateEnrollmentOperation",
                      "updateEnrollmentStudentRelationshipOperation": "#/components/schemas/updateEnrollmentStudentRelationshipOperation",
                      "updateStudentEnrollmentsRelationshipOperation": "#/components/schemas/updateStudentEnrollmentsRelationshipOperation",
                      "updateStudentMentorRelationshipOperation": "#/components/schemas/updateStudentMentorRelationshipOperation",
                      "updateStudentOperation": "#/components/schemas/updateStudentOperation",
                      "updateTeacherMentorsRelationshipOperation": "#/components/schemas/updateTeacherMentorsRelationshipOperation",
                      "updateTeacherOperation": "#/components/schemas/updateTeacherOperation",
                      "updateTeacherTeachesRelationshipOperation": "#/components/schemas/updateTeacherTeachesRelationshipOperation"
                    }
                  },
                  "x-abstract": true
                }
