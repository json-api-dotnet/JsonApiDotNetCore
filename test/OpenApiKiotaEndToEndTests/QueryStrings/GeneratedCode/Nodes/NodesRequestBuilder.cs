...
using OpenApiNSwagEndToEndTests.QueryStrings.GeneratedCode.Nodes.Item;
...
using System;
namespace OpenApiNSwagEndToEndTests.QueryStrings.GeneratedCode.Nodes {
    /// <summary>
    /// Builds and executes requests for operations under \nodes
    /// </summary>
    public class NodesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the OpenApiNSwagEndToEndTests.QueryStrings.GeneratedCode.nodes.item collection</summary>
        /// <param name="position">The identifier of the node to retrieve.</param>
        public NodesItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("id", position);
            return new NodesItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
...
#nullable enable
        public async Task<NodeCollectionResponseDocument?> GetAsync(Action<RequestConfiguration<NodesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<NodeCollectionResponseDocument> GetAsync(Action<RequestConfiguration<NodesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Stream?> HeadAsync(Action<RequestConfiguration<NodesRequestBuilderHeadQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Stream> HeadAsync(Action<RequestConfiguration<NodesRequestBuilderHeadQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToHeadRequestInformation(Action<RequestConfiguration<NodesRequestBuilderHeadQueryParameters>>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToHeadRequestInformation(Action<RequestConfiguration<NodesRequestBuilderHeadQueryParameters>> requestConfiguration = default) {
#endif
