...
namespace OpenApiKiotaEndToEndTests.IdObfuscation.GeneratedCode.BankAccounts.Item.Relationships
{
    ...
    public partial class RelationshipsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::OpenApiKiotaEndToEndTests.IdObfuscation.GeneratedCode.BankAccounts.Item.Relationships.RelationshipsRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RelationshipsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/bankAccounts/{id}/relationships", pathParameters)
        {
        }
