...
using System;
namespace OpenApiKiotaEndToEndTests.IdObfuscation.GeneratedCode.Operations
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::OpenApiKiotaEndToEndTests.IdObfuscation.GeneratedCode.Operations.OperationsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        public async Task<global::OpenApiKiotaEndToEndTests.IdObfuscation.GeneratedCode.Models.OperationsResponseDocument?> PostAsync(global::OpenApiKiotaEndToEndTests.IdObfuscation.GeneratedCode.Models.OperationsRequestDocument body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::OpenApiKiotaEndToEndTests.IdObfuscation.GeneratedCode.Models.OperationsResponseDocument>(requestInfo, global::OpenApiKiotaEndToEndTests.IdObfuscation.GeneratedCode.Models.OperationsResponseDocument.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="body">The request body</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        public RequestInformation ToPostRequestInformation(global::OpenApiKiotaEndToEndTests.IdObfuscation.GeneratedCode.Models.OperationsRequestDocument body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
            if(ReferenceEquals(body, null)) throw new ArgumentNullException(nameof(body));
            var requestInfo = new RequestInformation(Method.POST, UrlTemplate, PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/vnd.api+json;ext=\"https://jsonapi.org/ext/atomic https://www.jsonapi.net/ext/openapi\"");
            requestInfo.SetContentFromParsable(RequestAdapter, "application/vnd.api+json;ext=\"https://jsonapi.org/ext/atomic https://www.jsonapi.net/ext/openapi\"", body);
            return requestInfo;
        }
        ...
        /// </summary>
        /// <returns>A <see cref="global::OpenApiKiotaEndToEndTests.IdObfuscation.GeneratedCode.Operations.OperationsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::OpenApiKiotaEndToEndTests.IdObfuscation.GeneratedCode.Operations.OperationsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::OpenApiKiotaEndToEndTests.IdObfuscation.GeneratedCode.Operations.OperationsRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
