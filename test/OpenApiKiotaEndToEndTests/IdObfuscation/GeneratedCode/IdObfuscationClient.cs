...
namespace OpenApiKiotaEndToEndTests.IdObfuscation.GeneratedCode
{
    ...
    public partial class IdObfuscationClient : BaseRequestBuilder
    {
        ...
        /// <summary>The debitCards property</summary>
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::OpenApiKiotaEndToEndTests.IdObfuscation.GeneratedCode.IdObfuscationClient"/> and sets the default values.
        /// </summary>
        /// <param name="backingStore">The backing store to use for the models.</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public IdObfuscationClient(IRequestAdapter requestAdapter, IBackingStoreFactory backingStore = default) : base(requestAdapter, "{+baseurl}", new Dictionary<string, object>())
        {
