...
namespace OpenApiKiotaEndToEndTests.ClientIdGenerationModes.GeneratedCode.Models {
    ...
    public class PlayerRelationshipsInPostRequest : IBackedModel, IParsable 
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="PlayerRelationshipsInPostRequest"/> and sets the default values.
        /// </summary>
        public PlayerRelationshipsInPostRequest()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="PlayerRelationshipsInPostRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static PlayerRelationshipsInPostRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PlayerRelationshipsInPostRequest();
        }
        /// <summary>
