...
namespace OpenApiKiotaEndToEndTests.RestrictedControllers.GeneratedCode.RelationshipChannels.Item.Relationships.AudioStreams
{
    ...
    public partial class AudioStreamsRequestBuilder : BaseRequestBuilder
    {
        ...
        public AudioStreamsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/relationshipChannels/{id}/relationships/audioStreams", pathParameters)
        {
        }
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AudioStreamsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/relationshipChannels/{id}/relationships/audioStreams", rawUrl)
        {
        }
        ...
        {
            var requestInfo = new RequestInformation(Method.GET, "{+baseurl}/relationshipChannels/{id}/relationships/audioStreams{?query*}", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/vnd.api+json;ext=\"https://www.jsonapi.net/ext/openapi\"");
            return requestInfo;
        }
        ...
        {
            var requestInfo = new RequestInformation(Method.HEAD, "{+baseurl}/relationshipChannels/{id}/relationships/audioStreams{?query*}", PathParameters);
            requestInfo.Configure(requestConfiguration);
            return requestInfo;
        }
