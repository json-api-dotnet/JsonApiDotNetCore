...
namespace OpenApiKiotaEndToEndTests.RestrictedControllers.GeneratedCode.ReadOnlyResourceChannels.Item.VideoStream {
    ...
    public class VideoStreamRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// </summary>
        /// <returns>A <see cref="DataStreamSecondaryResponseDocument"/></returns>
...
#nullable enable
        public async Task<DataStreamSecondaryResponseDocument?> GetAsync(Action<RequestConfiguration<VideoStreamRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<DataStreamSecondaryResponseDocument> GetAsync(Action<RequestConfiguration<VideoStreamRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<DataStreamSecondaryResponseDocument>(requestInfo, DataStreamSecondaryResponseDocument.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
