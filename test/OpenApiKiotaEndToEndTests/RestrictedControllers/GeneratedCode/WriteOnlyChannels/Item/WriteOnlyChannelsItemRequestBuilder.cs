...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<WriteOnlyChannelPrimaryResponseDocument?> PatchAsync(UpdateWriteOnlyChannelRequestDocument body, Action<RequestConfiguration<WriteOnlyChannelsItemRequestBuilderPatchQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<WriteOnlyChannelPrimaryResponseDocument> PatchAsync(UpdateWriteOnlyChannelRequestDocument body, Action<RequestConfiguration<WriteOnlyChannelsItemRequestBuilderPatchQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(UpdateWriteOnlyChannelRequestDocument body, Action<RequestConfiguration<WriteOnlyChannelsItemRequestBuilderPatchQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(UpdateWriteOnlyChannelRequestDocument body, Action<RequestConfiguration<WriteOnlyChannelsItemRequestBuilderPatchQueryParameters>> requestConfiguration = default)
