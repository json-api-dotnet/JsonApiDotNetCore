...
namespace OpenApiKiotaEndToEndTests.RestrictedControllers.GeneratedCode.Models {
    ...
    public class UltraHighDefinitionVideoStream : DataInResponse, IParsable 
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public UltraHighDefinitionVideoStream_meta? Meta {
            get { return BackingStore?.Get<UltraHighDefinitionVideoStream_meta?>("meta"); }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="UltraHighDefinitionVideoStream"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new UltraHighDefinitionVideoStream CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new UltraHighDefinitionVideoStream();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                {"meta", n => { Meta = n.GetObjectValue<UltraHighDefinitionVideoStream_meta>(UltraHighDefinitionVideoStream_meta.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<UltraHighDefinitionVideoStream_meta>("meta", Meta);
        }
    }
}
