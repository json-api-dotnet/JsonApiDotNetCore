...
namespace OpenApiKiotaEndToEndTests.RestrictedControllers.GeneratedCode.Models {
    ...
    public class WriteOnlyChannelAttributesInPostRequest : IBackedModel, IParsable 
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="WriteOnlyChannelAttributesInPostRequest"/> and sets the default values.
        /// </summary>
        public WriteOnlyChannelAttributesInPostRequest()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="WriteOnlyChannelAttributesInPostRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static WriteOnlyChannelAttributesInPostRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new WriteOnlyChannelAttributesInPostRequest();
        }
        /// <summary>
