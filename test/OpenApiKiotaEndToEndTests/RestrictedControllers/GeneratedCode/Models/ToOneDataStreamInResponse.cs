...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ToOneDataStreamInResponse_meta? Meta {
            get { return BackingStore?.Get<ToOneDataStreamInResponse_meta?>("meta"); }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ToOneDataStreamInResponse"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ToOneDataStreamInResponse"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ToOneDataStreamInResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ToOneDataStreamInResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"meta", n => { Meta = n.GetObjectValue<ToOneDataStreamInResponse_meta>(ToOneDataStreamInResponse_meta.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<ToOneDataStreamInResponse_meta>("meta", Meta);
        }
    }
}
