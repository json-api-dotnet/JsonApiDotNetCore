...
namespace OpenApiKiotaEndToEndTests.RestrictedControllers.GeneratedCode.Models {
    ...
    public class WriteOnlyChannelAttributesInPatchRequest : IBackedModel, IParsable 
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="WriteOnlyChannelAttributesInPatchRequest"/> and sets the default values.
        /// </summary>
        public WriteOnlyChannelAttributesInPatchRequest()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="WriteOnlyChannelAttributesInPatchRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static WriteOnlyChannelAttributesInPatchRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new WriteOnlyChannelAttributesInPatchRequest();
        }
        /// <summary>
