...
namespace OpenApiKiotaEndToEndTests.RestrictedControllers.GeneratedCode.Models {
    ...
    public class WriteOnlyChannelRelationshipsInPatchRequest : IBackedModel, IParsable 
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="WriteOnlyChannelRelationshipsInPatchRequest"/> and sets the default values.
        /// </summary>
        public WriteOnlyChannelRelationshipsInPatchRequest()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="WriteOnlyChannelRelationshipsInPatchRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static WriteOnlyChannelRelationshipsInPatchRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new WriteOnlyChannelRelationshipsInPatchRequest();
        }
        /// <summary>
