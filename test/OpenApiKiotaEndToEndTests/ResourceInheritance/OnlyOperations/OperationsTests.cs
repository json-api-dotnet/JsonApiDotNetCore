...
using OpenApiKiotaEndToEndTests.ResourceInheritance.OnlyOperations.GeneratedCode;
using OpenApiKiotaEndToEndTests.ResourceInheritance.OnlyOperations.GeneratedCode.Models;
using OpenApiTests;
using OpenApiTests.ResourceInheritance;
using OpenApiTests.ResourceInheritance.Models;
using OpenApiTests.ResourceInheritance.OnlyOperations;
using TestBuildingBlocks;
using Xunit;
using Xunit.Abstractions;

namespace OpenApiKiotaEndToEndTests.ResourceInheritance.OnlyOperations;
    ...
    : IClassFixture<IntegrationTestContext<OpenApiStartup<ResourceInheritanceDbContext>, ResourceInheritanceDbContext>>, IDisposable
{
    ...
    public OperationsTests(IntegrationTestContext<OpenApiStartup<ResourceInheritanceDbContext>, ResourceInheritanceDbContext> testContext,
        ITestOutputHelper testOutputHelper)
    {
        ...
        testContext.ConfigureServices(services =>
        {
            ...
            services.RegisterTestOperationFilter();
        });
    }
    ...
    public async Task Test2()
    {
        ...
        var apiClient = new OnlyOperationsInheritanceClient(requestAdapter);
        ...
        OperationsRequestDocument requestBody = new()
        {
            ...
            [
                        ...
                        Relationships = new RelationshipsInCreateMansionRequest
                        {
                            Staff = new ToManyStaffMemberInRequest
                            {
                                ...
                                [
                                    ...
                                    {
                                        Type = StaffMemberResourceType.StaffMembers,
                ...
                new UpdateResidenceOperation
                {
                    ...
                    {
                        Type = BuildingResourceType.Residences,
                        Lid = familyHomeLid
                    },
