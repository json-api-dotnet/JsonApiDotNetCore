...
using OpenApiKiotaEndToEndTests.ResourceInheritance.Mixed.GeneratedCode;
using OpenApiKiotaEndToEndTests.ResourceInheritance.Mixed.GeneratedCode.Models;
using OpenApiTests;
...
namespace OpenApiKiotaEndToEndTests.ResourceInheritance.Mixed;
    ...
    : IClassFixture<IntegrationTestContext<OpenApiStartup<ResourceInheritanceDbContext>, ResourceInheritanceDbContext>>, IDisposable
{
    ...
    public async Task Can_create_concrete_derived_resource_at_abstract_endpoint()
    {
        ...
        var apiClient = new MixedInheritanceClient(requestAdapter);
