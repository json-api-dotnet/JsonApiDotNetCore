...
namespace OpenApiKiotaEndToEndTests.Links.GeneratedCode.Models {
    ...
    public class VacationAttributesInPostRequest : IBackedModel, IParsable 
    #pragma warning restore CS1591
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="VacationAttributesInPostRequest"/> and sets the default values.
        /// </summary>
        public VacationAttributesInPostRequest()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="VacationAttributesInPostRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static VacationAttributesInPostRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new VacationAttributesInPostRequest();
        }
        /// <summary>
