...
#nullable restore
        ...
        public static DataInResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            ...
            {
                "accommodations" => new AccommodationDataInResponse(),
                "excursions" => new ExcursionDataInResponse(),
                "transports" => new TransportDataInResponse(),
                "vacations" => new VacationDataInResponse(),
