...
namespace OpenApiKiotaEndToEndTests.Links.GeneratedCode.Models {
    ...
    public class Transport : DataInResponse, IParsable 
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Transport_meta? Meta {
            get { return BackingStore?.Get<Transport_meta?>("meta"); }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Transport"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new Transport CreateFromDiscriminatorValue(IParseNode parseNode)
        {
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                {"meta", n => { Meta = n.GetObjectValue<Transport_meta>(Transport_meta.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<Transport_meta>("meta", Meta);
        }
    }
}
