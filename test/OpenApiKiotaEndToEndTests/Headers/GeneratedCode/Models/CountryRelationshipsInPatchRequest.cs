...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="CountryRelationshipsInPatchRequest"/> and sets the default values.
        /// </summary>
        public CountryRelationshipsInPatchRequest()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="CountryRelationshipsInPatchRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static CountryRelationshipsInPatchRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new CountryRelationshipsInPatchRequest();
        }
        /// <summary>
