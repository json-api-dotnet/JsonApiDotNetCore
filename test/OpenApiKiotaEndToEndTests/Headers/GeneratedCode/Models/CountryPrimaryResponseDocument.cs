...
#nullable enable
        public Countries? Data {
            get { return BackingStore?.Get<Countries?>("data"); }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CountryPrimaryResponseDocument_meta? Meta {
            get { return BackingStore?.Get<CountryPrimaryResponseDocument_meta?>("meta"); }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="CountryPrimaryResponseDocument"/> and sets the default values.
        /// </summary>
        ...
        public static CountryPrimaryResponseDocument CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new CountryPrimaryResponseDocument();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                {"data", n => { Data = n.GetObjectValue<Countries>(Countries.CreateFromDiscriminatorValue); } },
                ...
                {"meta", n => { Meta = n.GetObjectValue<CountryPrimaryResponseDocument_meta>(CountryPrimaryResponseDocument_meta.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<Countries>("data", Data);
            ...
            writer.WriteObjectValue<CountryPrimaryResponseDocument_meta>("meta", Meta);
        }
    }
}
