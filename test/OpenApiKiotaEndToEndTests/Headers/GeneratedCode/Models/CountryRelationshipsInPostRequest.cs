...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="CountryRelationshipsInPostRequest"/> and sets the default values.
        /// </summary>
        public CountryRelationshipsInPostRequest()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="CountryRelationshipsInPostRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static CountryRelationshipsInPostRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new CountryRelationshipsInPostRequest();
        }
        /// <summary>
