...
namespace OpenApiKiotaEndToEndTests.Headers.GeneratedCode.Countries.Item {
    ...
    public class CountriesItemRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>
        /// Instantiates a new CountriesItemRequestBuilder and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Stream?> HeadAsync(Action<RequestConfiguration<CountriesItemRequestBuilderHeadQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Stream> HeadAsync(Action<RequestConfiguration<CountriesItemRequestBuilderHeadQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
