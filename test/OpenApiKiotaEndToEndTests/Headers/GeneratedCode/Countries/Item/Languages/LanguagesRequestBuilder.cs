...
namespace OpenApiKiotaEndToEndTests.Headers.GeneratedCode.Countries.Item.Languages {
    ...
    public class LanguagesRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// </summary>
        /// <returns>A <see cref="LanguageCollectionResponseDocument"/></returns>
...
#nullable enable
        public async Task<LanguageCollectionResponseDocument?> GetAsync(Action<RequestConfiguration<LanguagesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<LanguageCollectionResponseDocument> GetAsync(Action<RequestConfiguration<LanguagesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<LanguageCollectionResponseDocument>(requestInfo, LanguageCollectionResponseDocument.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
