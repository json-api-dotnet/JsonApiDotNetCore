    ...
    where TDbContext : TestableDbContext
{
    ...
    public void ConfigureLogging(Action<ILoggingBuilder> loggingConfiguration)
    {
        ...
        {
            throw new InvalidOperationException($"Do not call {ConfigureLogging} multiple times.");
        }
    ...
    public void ConfigureServices(Action<IServiceCollection> configureServices)
    {
        ...
        {
            throw new InvalidOperationException($"Do not call {ConfigureServices} multiple times.");
        }
    ...
    public void PostConfigureServices(Action<IServiceCollection> postConfigureServices)
    {
        ...
        {
            throw new InvalidOperationException($"Do not call {PostConfigureServices} multiple times.");
        }
