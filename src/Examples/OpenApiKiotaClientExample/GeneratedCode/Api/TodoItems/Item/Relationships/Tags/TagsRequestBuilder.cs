...
namespace OpenApiKiotaClientExample.GeneratedCode.Api.TodoItems.Item.Relationships.Tags
{
    ...
    public partial class TagsRequestBuilder : BaseRequestBuilder
    {
        ...
        public TagsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/todoItems/{id}/relationships/tags", pathParameters)
        {
        }
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TagsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/todoItems/{id}/relationships/tags", rawUrl)
        {
        }
        ...
        {
            var requestInfo = new RequestInformation(Method.GET, "{+baseurl}/api/todoItems/{id}/relationships/tags{?query*}", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/vnd.api+json;ext=\"https://www.jsonapi.net/ext/openapi\"");
            return requestInfo;
        }
        ...
        {
            var requestInfo = new RequestInformation(Method.HEAD, "{+baseurl}/api/todoItems/{id}/relationships/tags{?query*}", PathParameters);
            requestInfo.Configure(requestConfiguration);
            return requestInfo;
        }
