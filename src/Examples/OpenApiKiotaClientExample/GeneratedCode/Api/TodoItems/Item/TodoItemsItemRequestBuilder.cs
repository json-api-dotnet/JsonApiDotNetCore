...
namespace OpenApiKiotaClientExample.GeneratedCode.Api.TodoItems.Item {
    ...
    public class TodoItemsItemRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>
        /// Instantiates a new TodoItemsItemRequestBuilder and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Stream?> HeadAsync(Action<RequestConfiguration<TodoItemsItemRequestBuilderHeadQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Stream> HeadAsync(Action<RequestConfiguration<TodoItemsItemRequestBuilderHeadQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
