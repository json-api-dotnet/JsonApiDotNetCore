...
namespace OpenApiKiotaClientExample.GeneratedCode.Models {
    ...
    public class TodoItemAttributesInPatchRequest : IBackedModel, IParsable 
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="TodoItemAttributesInPatchRequest"/> and sets the default values.
        /// </summary>
        public TodoItemAttributesInPatchRequest()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="TodoItemAttributesInPatchRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static TodoItemAttributesInPatchRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new TodoItemAttributesInPatchRequest();
        }
        /// <summary>
