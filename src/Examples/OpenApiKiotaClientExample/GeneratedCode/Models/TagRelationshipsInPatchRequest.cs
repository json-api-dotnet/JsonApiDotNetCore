...
namespace OpenApiKiotaClientExample.GeneratedCode.Models {
    ...
    public class TagRelationshipsInPatchRequest : IBackedModel, IParsable 
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="TagRelationshipsInPatchRequest"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="TagRelationshipsInPatchRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static TagRelationshipsInPatchRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new TagRelationshipsInPatchRequest();
        }
        /// <summary>
