...
namespace OpenApiKiotaClientExample.GeneratedCode.Models {
    ...
    public class PersonRelationshipsInPostRequest : IBackedModel, IParsable 
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="PersonRelationshipsInPostRequest"/> and sets the default values.
        /// </summary>
        public PersonRelationshipsInPostRequest()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="PersonRelationshipsInPostRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static PersonRelationshipsInPostRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PersonRelationshipsInPostRequest();
        }
        /// <summary>
