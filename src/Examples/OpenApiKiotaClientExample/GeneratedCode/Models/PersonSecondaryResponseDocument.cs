...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public PersonSecondaryResponseDocument_meta? Meta {
            get { return BackingStore?.Get<PersonSecondaryResponseDocument_meta?>("meta"); }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="PersonSecondaryResponseDocument"/> and sets the default values.
        /// </summary>
        ...
        public static PersonSecondaryResponseDocument CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PersonSecondaryResponseDocument();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"meta", n => { Meta = n.GetObjectValue<PersonSecondaryResponseDocument_meta>(PersonSecondaryResponseDocument_meta.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<PersonSecondaryResponseDocument_meta>("meta", Meta);
        }
    }
}
