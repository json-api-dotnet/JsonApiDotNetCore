...
namespace OpenApiKiotaClientExample.GeneratedCode.Models {
    ...
    public class TodoItems : DataInResponse, IParsable 
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public TodoItems_meta? Meta {
            get { return BackingStore?.Get<TodoItems_meta?>("meta"); }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="TodoItems"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new TodoItems CreateFromDiscriminatorValue(IParseNode parseNode)
        {
