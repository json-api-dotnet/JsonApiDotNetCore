...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="AttributesInCreateTodoItemRequest"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="AttributesInCreateTodoItemRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static AttributesInCreateTodoItemRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new AttributesInCreateTodoItemRequest();
        }
        /// <summary>
