...
namespace OpenApiKiotaClientExample.GeneratedCode.Models
{
    ...
    public class CreatePersonOperation : OpenApiKiotaClientExample.GeneratedCode.Models.AtomicOperation, IParsable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="OpenApiKiotaClientExample.GeneratedCode.Models.CreatePersonOperation"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new OpenApiKiotaClientExample.GeneratedCode.Models.CreatePersonOperation CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new OpenApiKiotaClientExample.GeneratedCode.Models.CreatePersonOperation();
        }
        /// <summary>
