...
namespace OpenApiKiotaClientExample.GeneratedCode.Models
{
    ...
    public class RemoveFromPersonOwnedTodoItemsRelationshipOperation : OpenApiKiotaClientExample.GeneratedCode.Models.AtomicOperation, IParsable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="OpenApiKiotaClientExample.GeneratedCode.Models.RemoveFromPersonOwnedTodoItemsRelationshipOperation"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new OpenApiKiotaClientExample.GeneratedCode.Models.RemoveFromPersonOwnedTodoItemsRelationshipOperation CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new OpenApiKiotaClientExample.GeneratedCode.Models.RemoveFromPersonOwnedTodoItemsRelationshipOperation();
        }
        /// <summary>
