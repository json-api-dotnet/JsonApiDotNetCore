...
//                builder.Add(metaEntity.GetMeta());
...
//            if (_jsonApiContext.Options.DefaultRelationshipLinks.HasFlag(Link.None) == false && attr.RelationshipLinks.HasFlag(Link.None) == false)
//            {
//                relationshipData.Links = new RelationshipLinks();
//                if (attr.RelationshipLinks.HasFlag(Link.Self))
//                {
...
//                if (attr.RelationshipLinks.HasFlag(Link.Related))
//                {
