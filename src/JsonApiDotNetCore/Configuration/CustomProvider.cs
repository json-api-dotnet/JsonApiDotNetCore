...
namespace JsonApiDotNetCore.Configuration
{
    ...
    /// </summary>
    internal sealed class DataAnnotationsModelValidatorProvider_COPY : IMetadataBasedModelValidatorProvider
    {
        ...
        public DataAnnotationsModelValidatorProvider_COPY(
        ...
        public void CreateValidators(ModelValidatorProviderContext context)
        {
            ...
            for (var i = 0; i < context.Results.Count; i++)
            {
                ...
                var validator = new DataAnnotationsModelValidator_COPY(
            ...
            if (typeof(IValidatableObject).IsAssignableFrom(context.ModelMetadata.ModelType))
            {
                ...
                {
                    Validator = new ValidatableObjectAdapter_COPY(),
                    IsReusable = true
                });
            }
        }
    ...
    public class ValidatableObjectAdapter_COPY : IModelValidator
    {
