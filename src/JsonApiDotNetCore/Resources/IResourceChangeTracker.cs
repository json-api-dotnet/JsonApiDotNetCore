namespace JsonApiDotNetCore.Resources
{
    ...
    {
        /// <summary>
        /// Sets the exposed resource attributes as stored in database, before applying the PATCH operation. For POST operations, this sets exposed resource
        ...
        /// <summary>
        /// Validates if any exposed resource attributes that were not in the POST or PATCH request have been changed. And validates if the values from the
        /// request are stored without modification.
        /// </summary>
        /// <returns>
