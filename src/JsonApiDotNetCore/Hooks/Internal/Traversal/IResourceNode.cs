...
namespace JsonApiDotNetCore.Hooks.Internal.Traversal
{
    ...
    internal interface IResourceNode
    {
        ...
        /// <summary>
        /// A helper method to assign relationships to the previous layer after firing hooks. Or, in case of the root node, to update the original source
        /// enumerable.
        /// </summary>
        void Reassign(IEnumerable source = null);

        /// <summary>
        /// A helper method to internally update the unique set of resources as a result of a filter action in a hook.
        /// </summary>
