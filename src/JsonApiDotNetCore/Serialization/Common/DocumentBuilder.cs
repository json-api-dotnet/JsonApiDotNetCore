...
namespace JsonApiDotNetCore.Serialization
{
    ...
    /// Uses <see cref="IResourceObjectBuilder"/> to convert resources in to <see cref="ResourceObject"/>s and wraps them in a <see cref="Document"/>.
    /// </summary>
    public abstract class BaseDocumentBuilder
    {
        ...
        /// <summary>
        /// Builds a <see cref="Document"/> for <paramref name="resource"/>.
        ...
        /// Adds the attributes and relationships that are enlisted in <paramref name="attributes"/> and <paramref name="relationships"/>
        /// </summary>
        /// <param name="resources">Resource to build a Resource Object for</param>
        /// <param name="attributes">Attributes to include in the building process</param>
        /// <param name="relationships">Relationships to include in the building process</param>
        /// <returns>The resource object that was built</returns>
        protected Document Build(IEnumerable<IIdentifiable> resources, IReadOnlyCollection<AttrAttribute> attributes, IReadOnlyCollection<RelationshipAttribute> relationships)
        {
