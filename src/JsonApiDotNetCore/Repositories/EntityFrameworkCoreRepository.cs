...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    private void EnsureIncomingNavigationsAreTracked(TResource resourceTracked)
    {
        ...
        var scopeFactory = new LambdaScopeFactory();
    ...
    {
        return Expression.Call(typeof(Queryable), "Where", [lambdaScope.Parameter.Type], source, predicate);
    }
    ...
    private Expression IncludeExtensionMethodCall(Expression source, LambdaScope lambdaScope, string navigationPropertyPath)
    {
        ...
        return Expression.Call(typeof(EntityFrameworkQueryableExtensions), "Include", [lambdaScope.Parameter.Type], source, navigationExpression);
    }
