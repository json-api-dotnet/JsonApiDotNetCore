    ...
    where TResource : class, IIdentifiable<TId>
{
    ...
    /// </remarks>
    Task<TResource> GetForCreateAsync(Type resourceClrType, [DisallowNull] TId id, CancellationToken cancellationToken);
    ...
    /// </summary>
    Task DeleteAsync(TResource? resourceFromDatabase, [DisallowNull] TId id, CancellationToken cancellationToken);
    ...
    /// </summary>
    Task AddToToManyRelationshipAsync(TResource? leftResource, [DisallowNull] TId leftId, ISet<IIdentifiable> rightResourceIds,
