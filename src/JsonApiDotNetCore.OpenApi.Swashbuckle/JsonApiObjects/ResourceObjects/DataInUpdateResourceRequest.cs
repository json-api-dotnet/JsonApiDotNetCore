...
internal abstract class DataInUpdateResourceRequest : ResourceData;

[UsedImplicitly(ImplicitUseTargetFlags.Members)]
internal sealed class DataInUpdateResourceRequest<TResource> : DataInUpdateResourceRequest
